...
parser.add_argument('--lr', type=str, default='[0.001]*4000', help='learning rates for steps(list form)')
...
parser.add_argument('--env', default='rtfm_recognition', help='viz env')
