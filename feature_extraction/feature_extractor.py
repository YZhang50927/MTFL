...
def get_args():
    ...
    # io
    parser.add_argument('--dataset_path', default='/media/mount_loc/yiling/VAD3',
    ...
    parser.add_argument('--save_dir', type=str, default="/media/mount_loc/yiling/C3D_32Train_32Test",
    ...
    # model
    parser.add_argument('--model_type', default='c3d',
                        type=str,
                        # required=True,
                        help="type of feature extractor",
                        choices=['c3d', 'i3d', 'mfnet'])
    parser.add_argument('--pretrained_3d',
                        default='/media/mount_loc/yiling/models/pretrained_feature_extraction_models/c3d.pickle',
                        type=str,
    ...
    with torch.no_grad():
        for data, clip_idxs, dirs, vid_names in data_iter:
            ...
            if len(outputs.shape) > 2:
                outputs = np.reshape(outputs, outputs.shape[0:2])
