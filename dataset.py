...
import os
import torch
from utils.feature_reader import read_features
...
class Dataset(data.Dataset):
    ...
    def _parse_list(self):
        ...
        if self.type == 'i3d':
            ...
            features_path = '/media/DataDrive/yiling/features/VST_32Train_32Test_kinetics'
        elif self.type == 'mvit':
            features_path = '/media/DataDrive/yiling/features/MViTv2_B_32x3_k400_32f'
            self.ext = '.npy'
        elif self.type == 'slowfast':
            features_path = '/media/DataDrive/yiling/features/SLOWFAST_8x8_R50_8f'
            self.ext = '.npy'
        # test dataset
    ...
    def _get_features_list(self, features_path, annotation_path):
        ...
        with open(annotation_path) as f:
            ...
            for line in lines:
                ...
                feature_path = os.path.join(features_path, file + self.ext)
                if self.test_mode:
