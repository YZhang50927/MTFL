...
parser.add_argument('--lr', type=str, default='[0.001]*2200', help='learning rates for steps(list form)')
...
parser.add_argument('--max-epoch', type=int, default=2200, help='maximum iteration to train (default: 100)')
...
parser.add_argument('--load_model', default='/media/mount_loc/yiling/Test/models/rtfm-i3d-1560.pkl', help='model path')
parser.add_argument('--test_path', default='/media/mount_loc/yiling/Test/results', help='Test results of final model')
