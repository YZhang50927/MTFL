...
parser.add_argument('--feature_type', default='vst', help='the model used for feature extraction, i3d, c3d, or vst')
...
parser.add_argument('--model-name', default='vst_rtfm', help='name to save model')
...
parser.add_argument('--save_models', default='/media/DataDrive/yiling/models/VST_RTFM', help='saving path')
parser.add_argument('--output_path', default='/media/DataDrive/yiling/results/finetune/', help='result path')
